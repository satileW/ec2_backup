...
<?php
	if(!isset($_COOKIE['count_magical_creature_cat'])){
                setcookie('count_magical_creature_cat',1);
        }else{
                $count=++$_COOKIE['count_magical_creature_cat'];
                setcookie('count_magical_creature_cat',$count);
        }  
	setcookie("Magical_creature_cat",time());
?>
<img src = "./p7.jpg" alt = "Harry">
<p>This is the cat Hermione Granger raised before.</p>
