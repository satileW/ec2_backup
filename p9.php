...
<?php
	 if(!isset($_COOKIE['count_magical_creature_pigeon'])){
                setcookie('count_magical_creature_pigeon',1);
        }else{
                $count=++$_COOKIE['count_magical_creature_pigeon'];
                setcookie('count_magical_creature_pigeon',$count);
        } 
	setcookie("Magical_creature_Pigeon",time());
?>
<img src = "./p9.jpg" alt = "Harry">
<p>This is the pigeon carrier can bring your messege to magic world.</p>
<tr>
