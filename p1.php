...
<?php
	if(!isset($_COOKIE['count_magic_stick'])){
		setcookie('count_magic_stick',1);
	}else{
		$count=++$_COOKIE['count_magic_stick'];
		setcookie('count_magic_stick',$count);
	} 
	setcookie("magic_stick",time());
?>
<img src = "./p1.png" alt = "Harry">
<p>This is the magic stick used by RoeN~</p>
<tr>
