...
<?php
	if(!isset($_COOKIE['count_invisibility_cloak'])){
                setcookie('count_invisibility_cloak',1);
        }else{
                $count=++$_COOKIE['count_invisibility_cloak'];
                setcookie('count_invisibility_cloak',$count);
        }  
	setcookie("Invisibility_Cloak",time());
?>
<img src = "./p5.jpg" alt = "Harry">
<p>This is the cloak can make you invisible under it.</p>
<tr>
