...
<?php
	if(!isset($_COOKIE['count_magical_creature_dog'])){
                setcookie('count_magical_creature_dog',1);
        }else{
                $count=++$_COOKIE['count_magical_creature_dog'];
                setcookie('count_magical_creature_dog',$count);
        }  
	setcookie("Magical_creature_dog",time());
?>
<img src = "./p8.jpg" alt = "Harry">
<p>This is the three dog son from second session.</p>
