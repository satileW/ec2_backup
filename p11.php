...
<?php 
	if(!isset($_COOKIE['count_magical_creature_squirrel'])){
                setcookie('count_magical_creature_squirrel',1);
        }else{
                $count=++$_COOKIE['count_magical_creature_squirrel'];
                setcookie('count_magical_creature_squirrel',$count);
        }
	setcookie("Magical_creature_Squirrel",time());
?>
<img src = "./p11.jpg" alt = "Harry">
<p>This is the squirrel appear in every corner of university, and throw to the magic world have magic power.</p>
<tr>
