...
<?php
	if(!isset($_COOKIE['count_magic_hat'])){
                setcookie('count_magic_hat',1);
        }else{
                $count=++$_COOKIE['count_magic_hat'];
                setcookie('count_magic_hat',$count);
        }  
	setcookie("magic_hat",time());
?>
<img src = "./p4.png" alt = "Harry">
<p>This is the Sorting Hat which will seperate students to four school.</p>
<tr>
